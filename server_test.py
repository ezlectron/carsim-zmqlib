...
from zmqlib import ZeroMqServerController, EngineSimZeroMqCarControlRequestMessage, EngineSimZeroMqCarStateResponseMessage

logging.basicConfig(filename='/tmp/zmqlib-server-test.log', level=logging.INFO)

def callback_func(msg : EngineSimZeroMqCarControlRequestMessage):
    print (msg)
